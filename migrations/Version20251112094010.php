 ...
 */
final class Version20251112094010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation CHANGE title title VARCHAR(100) NOT NULL, CHANGE video_id video_id VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation CHANGE title title VARCHAR(100) DEFAULT NULL, CHANGE video_id video_id VARCHAR(20) DEFAULT NULL');
